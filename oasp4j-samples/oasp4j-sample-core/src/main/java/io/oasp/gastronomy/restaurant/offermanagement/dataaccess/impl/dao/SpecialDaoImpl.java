  ...
  public PaginatedListTo<SpecialEntity> findSpecials(SpecialSearchCriteriaTo criteria) {
    ...
    if (activePeriod != null) {
      query.where(Alias.$(special.getActivePeriod().getEndingHour()).eq(activePeriod.getEndingHour()),
          Alias.$(special.getActivePeriod().getStartingHour()).eq(activePeriod.getStartingHour()),
          Alias.$(special.getActivePeriod().getEndingDay()).eq(activePeriod.getEndingDay()),
          Alias.$(special.getActivePeriod().getStartingDay()).eq(activePeriod.getStartingDay()));
    }
